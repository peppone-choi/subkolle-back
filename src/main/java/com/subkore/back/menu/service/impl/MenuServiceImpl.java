...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuResponseDto createMenu(CreateMenuRequestDto createMenuRequestDto) {
        if (createMenuRequestDto.icon() == null || createMenuRequestDto.text() == null
            || createMenuRequestDto.linkTo() == null) {
    ...
    @Override
    public MenuResponseDto updateMenu(Long id, UpdateMenuRequestDto updateMenuRequestDto) {
        if (menuRepository.existsById(id)) {
            Menu menu = menuRepository.findById(id).get();
            menuMapper.updateMenuRequestDtoToMenu(updateMenuRequestDto, menu);
